...
import styles from "./AddFoundItemModal.module.css";
...
export default function AddFoundItemModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const validation = validateFoundItem(normalizedFormData);
      ...
      // Step 2: Build FormData directly from the form to ensure file inclusion
      const data = new FormData(e.currentTarget);
      data.set("date_found", normalizedFormData.date_found);
      ...
      // Step 5: Close modal and trigger success callback
      onClose();
      if (onSuccess) onSuccess();
    } catch (err) {
      // Only show API errors (validation errors already shown)
            ...
            <div className={styles.twoCol}>
              ...
              <div className={styles.formGroup}>
                <label htmlFor="date_found">
                  Date Found <span className={styles.required}>*</span>
                </label>
                <input
                  type="date"
                  id="date_found"
                  ...
                  className={fieldErrors.date_found ? styles.inputError : ""}
                />
          ...
          <div className={styles.adminSection}>
            ...
            <div className={styles.formGroup}>
              ...
              <textarea
                ...
                className={fieldErrors.admin_verification_details ? styles.inputError : ""}
              />
