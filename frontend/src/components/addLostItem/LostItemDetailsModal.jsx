...
import styles from "./LostItemDetailsModal.module.css";
...
export default function LostItemDetailsModal({
  open,
  item,
  onClose,
  onSuccess,
  ...
  const isResolved =
    normalizedStatus === "resolved" || normalizedStatus === "returned";
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      formData.set("lost_item_id", item.id);
                    ...
                    {item.lostDate && (
                      <div className={styles.infoItem}>
                        ...
                        <div>
                          ...
                          <div>{formatNepaliTime(item.lostDate)}</div>
                        </div>
                      </div>
                    )}
